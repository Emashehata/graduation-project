...
@Component({
  selector: 'app-update-doctor-appointment',
  imports: [FormsModule ,ReactiveFormsModule],
  templateUrl: './update-doctor-appointment.component.html',
  styleUrl: './update-doctor-appointment.component.css'
})
export class UpdateDoctorAppointmentComponent implements OnInit{
daysList = [
    { id: 6, name: 'السبت' },
    { id: 0, name: 'الأحد' },
    { id: 1, name: 'الإثنين' },
  ...
  updateAppointment(): void {
    ...
    this._AppointmentsService.UpdateAppointment(this.appointmentId, requestData).subscribe(
      res => {
        ...
        this.router.navigate(['/docAppoitment']);
      },
      error => {
